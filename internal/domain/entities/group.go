...
// GroupRole represents user roles in a group
...
type GroupMember struct {
	...
	LeftAt   *time.Time          `bson:"left_at,omitempty" json:"leftAt,omitempty"`
	IsActive bool                `bson:"is_active" json:"isActive"`
}

// GroupInvite represents a group invitation
...
// GroupActivity represents group activity logs
...
type UpdateGroupSettingsRequest struct {
	...
	DisappearingMessages *bool  `json:"disappearingMessages,omitempty"`
...
type MuteGroupRequest struct {
	Duration int `json:"duration"` // in seconds, -1 for forever
}
